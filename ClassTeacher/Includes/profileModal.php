<style>
    ...
    .confirm-logout-btn { background: #ff4757; color: white !important; border-radius: 10px; padding: 10px 25px; border: none; font-weight: 600; text-decoration: none; display: inline-block; }
                ...
                <div id="modalProfileInfo">
                    <div class="identity-grid">
                        <div class="info-group">
                            ...
                            <span class="info-value"><?php echo !empty($rows['gender']) ? $rows['gender'] : 'N/A'; ?></span>
                        </div>
                        <div class="info-group">
                            <span class="info-label">Date of Birth</span>
                            <span class="info-value"><?php echo !empty($rows['dob']) ? $rows['dob'] : 'N/A'; ?></span>
                        </div>
                        <div class="info-group">
                            <span class="info-label">Nationality</span>
                            <span class="info-value"><?php echo !empty($rows['nationality']) ? $rows['nationality'] : 'N/A'; ?></span>
                        </div>
                        <div class="info-group">
                            <span class="info-label">Marital Status</span>
                            <span class="info-value"><?php echo !empty($rows['maritalStatus']) ? $rows['maritalStatus'] : 'N/A'; ?></span>
                        </div>
                        <div class="info-group">
                        ...
                        <div class="info-group full-row">
                            ...
                            <span class="info-value"><?php echo !empty($rows['address']) ? $rows['address'] : 'Address not updated'; ?></span>
                        </div>
                    </div>
                </div>

                <p class="text-muted small px-5 mt-3" id="modalLogoutText" style="display:none;">
                    Confirm: end your <strong><?php echo $userRole; ?></strong> session and logout?
                </p>
